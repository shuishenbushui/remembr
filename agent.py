...
class ReMEmbRAgent(Agent):
    ...
    def __init__(self, llm_type='gpt-4o', num_ctx=8192, temperature=0):
        ...
        # top_level_path = str(os.path.dirname(__file__)) + '/../'  # changed by sxf
    ...
    def generate(self, state):
        ...
        try:
            ...
            keys_to_check_for = ["time", "text", "binary", "position", "duration", "orientation"] # changed by sxf
            ...
            # added by sxf
            if type(parsed['orientation']) == str:
                parsed['orientation'] = eval(parsed['orientation'])[0]
